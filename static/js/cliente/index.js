    ...
    $.ajax({
        ...
        success: function(response){
            ...
            for(let i = 0;i < response.length;i++){
                ...
                fila += 'onclick = "abrir_modal_edicion(\'/cliente/editar_cliente/'+response[i]['pk']+'/\')"><i class="fa fa-pencil"> Editar</i></button>';
                fila += '<button type = "button" class = "btn btn-danger btn-sm tableButton"';
                fila += 'onclick = "abrir_modal_eliminacion(\'/cliente/eliminar_cliente/'+response[i]['pk']+'/\')"><i class="fa fa-trash"> Eliminar</i></button> </td>'
                fila += '</tr>';
